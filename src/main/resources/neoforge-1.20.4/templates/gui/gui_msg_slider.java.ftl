...
@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD) public record ${name}SliderMessage(int sliderID, int x, int y, int z, double value) implements CustomPacketPayload {

	public static final ResourceLocation ID = new ResourceLocation(${JavaModName}.MODID, "${registryname}_sliders");
	...
	@SubscribeEvent public static void registerMessage(FMLCommonSetupEvent event) {
		${JavaModName}.addNetworkMessage(${name}SliderMessage.ID, ${name}SliderMessage::new, ${name}SliderMessage::handleData);
	}
}
<#-- @formatter:on -->